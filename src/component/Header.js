...
const Header = () => {
    ...
    window.addEventListener("scroll", HeaderNavbar)
        ...
        return (
            ...
            <nav className={HeaderNav ? "HeaderNav active" : "HeaderNav"}  id="home">
            ...
            {/* // <nav className={HeaderNav ? "homeContent active" : "homeContent"}  > */}
                ...
                {/* // <div className={active ? "HeaderRebonsivNav" : "right-h"} onClick={() => { */}
                    {/* // setActive(true) */}
                {/* // }}> */}
                     <Link onClick={()=>setMenueOpen(false) } to="home"  smooth={true} span={true} className="homeActive" >Home</Link>
                     <Link onClick={() => setMenueOpen(false)} to="skills" smooth={true} span={true}  >Skills</Link>
                     <Link onClick={()=>setMenueOpen(false) }  to="projects"  smooth={true} span={true} >Projects</Link>
                    ...
                    <div className="right-icons">
                        ...
                        <div onClick={()=>setMenueOpen(false) } smooth={true} span={true}  className="circlSoical" >
                            ...
                            <Link onClick={()=>setMenueOpen(false) } smooth={true} span={true} to="Contact" >
                                <button className="btn" onClick={() =>  ("/contact")} > Let's Contact  </button>
